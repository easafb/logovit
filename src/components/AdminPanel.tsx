...
import { Image as ImageIcon, Plus, Pencil, Trash2, X, Download, Upload, Search } from "lucide-react";
...
type Props = {
  ...
  products: Product[];
  /** Çağıran sayfada hâlâ varsa uyumluluk için bıraktık; içeride kullanılmıyor. */
  setProducts?: React.Dispatch<React.SetStateAction<Product[]>>;
  onCreate?: (p: Omit<Product, "id">) => Promise<void> | void;
  onUpdate?: (p: Product) => Promise<void> | void;
...
export default function AdminPanel({
  ...
  setOpen,
  products,
  setProducts, // eslint-disable-line @typescript-eslint/no-unused-vars
  onCreate,
  onUpdate,
  onDelete,
}: Props) {
  ...
  const reset = () => {
    setEditingId(null);
    setForm({ name: "", sku: "", price: 0, tag: "", image: "" });
  };
  ...
  return (
    ...
    >
      <SheetContent
        className="w-full sm:max-w-3xl p-0 h-screen overflow-y-auto"
      ...
      >
        ...
        >
          <SheetHeader className="px-5 pt-4 pb-3">
            <div className="flex items-center justify-between">
              ...
              <Button variant="outline" className="btn-outline h-8 px-3" onClick={() => setOpen(false)}>
        ...
        <div className="p-5 space-y-10">
            ...
            <div className="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="grid gap-2">
                ...
                <Input
                  ...
                  type="number"
                  step="0.01"
                  value={form.price ?? ""} // input'ta string gösterim serbest
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                    setForm((f) => ({
                      ...f,
                      // boşken undefined; doluyken number
              ...
              <div className="md:col-span-2 flex items-center gap-2">
                <Button
                  ...
                  style={{ backgroundColor: "var(--orange-base)" }}
                >
          ...
          <div className="space-y-3">
            ...
            <div
              className="ap-table border rounded-2xl overflow-hidden"
